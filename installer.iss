; Inno Setup script — builds dist\RentalPro-Setup.exe
...
OutputDir=dist
OutputBaseFilename=RentalPro-Setup
...
[Files]
Source: "dist\RentalPro\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
